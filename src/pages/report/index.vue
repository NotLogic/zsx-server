  ...
  <div class="report">
    ...
    <Modal v-model="dialogShow" :title="label[currDialog]" :mask-closable="false" @on-cancel="resetDialogForm('formDialog')">
      <Form :model="formDialog" ref="formDialog" :rules="rules" :label-width="80">
        <Row>
          <Col span="12">
            <FormItem label="举报分类" prop="reportClassId">
              <Select v-model="formDialog.reportClassId" placeholder="请选择举报分类">
                <Option v-for="item in reportClassId" :key="item.value" :value="item.value">{{item.label}}</Option>
              </Select>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="举报信息" prop="reportInfo">
