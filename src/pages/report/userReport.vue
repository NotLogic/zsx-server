  ...
  <div class="user-report">
    ...
    <Modal v-model="dialogShow" :title="label[currDialog]" :mask-closable="false" @on-cancel="resetDialogForm('formDialog')" width="700">
      <Form :model="formDialog" ref="formDialog" :rules="rules" :label-width="80">
        <Row>
          <Col span="12">
            <FormItem label="举报类型" prop="type">
              <Select v-model="formDialog.type" placeholder="请选择">
                <Option v-for="item in reportClass" :key="item.value" :value="item.value">{{item.label}}</Option>
              </Select>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="举报的内容的ID" prop="reportTypeId">
              <Input v-model="formDialog.reportTypeId" placeholder="请手动输入"></Input>
              <!-- <Select v-model="formDialog.reportTypeId" placeholder="请选择">
                <Option v-for="item in reportClass" :key="item.value" :value="item.value">{{item.label}}</Option>
              </Select> -->
            </FormItem>
          </Col>
        ...
        <Row>
          <Col span="12">
            <FormItem label="举报信息" prop="reportId">
              <!-- 举报信息可以多选 -->
              <Select v-model="formDialog.reportId" placeholder="请选择" multiple>
                <Option v-for="item in reportId" :key="item.value" :value="item.value">{{item.label}}</Option>
              </Select>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="举报用户" prop="userId">
        ...
        <Row>
          <Col span="12">
            <FormItem label="是否有效" prop="reportStatus">
        ...
        <Row>
          <Col span="24">
            <FormItem label="举报内容" prop="reportContent">
