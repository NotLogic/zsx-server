  ...
  <div class="user">
    <div id="search-wrapper">
      ...
      <Form :model="formSearch" ref="formSearch" inline :label-width="60">
        ...
        <Button v-if="hasPerm('app:add')" type="primary" style="margin: 5px 8px 24px 0;" @click="addRow" size="small">{{label.add}}</Button>
        <Button v-if="hasPerm('post_index:add')" type="primary" style="margin: 5px 8px 24px 0;" @click="postAddRow(false)" size="small">发帖</Button>
        ...
        columns: [
          ...
          },
          {
            ...
            render: (create, params) => {
              ...
              if(vm.hasPerm('post_index:add')){
                arr2.push(vm.createPostBtn(create, params.row.id))
                arr2.push(vm.createPreviewPostBtn(create,params.row))
              }
