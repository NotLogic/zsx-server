        ...
        <Row>
          <Col span="12">
            <FormItem label="推送类型" prop="pushType">
              <Select v-model="selectPushType" @on-change="pushTypeChange"  placeholder="请选择推送类型">
    ...
    data(){
      return {
        url: {
          ...
          sId: 'id/id',
          upload: 'file/',
          one: 'web/push/sendToOne',
          all: 'web/push/sendAll',
          allUser: 'user/all/user',
        },
        // 推送请求的url，根据选择的推送类型变化
        currentUrl: 'web/push/sendAll',
        needId: true,
        pager: {
      ...
      submitDialogForm (name) {
        ...
        vm.$refs[name].validate(function (valid) {
          if (valid) {
            ...
            let ajaxUrl = currDialog == 'add' ? vm.currentUrl : vm.url.edit
